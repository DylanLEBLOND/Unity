...
namespace SandboxPlayer
{
	class Launcher
	{
		...
		{
			PROOFNUMBERSEARCH, MONTECARLO, NEGASCOUT, NEOALPHABETA, ALPHABETA, MINMAX
		};

		public static Algorithm goteAlgorithm = Algorithm.PROOFNUMBERSEARCH;
		public static Algorithm senteAlgorithm = Algorithm.NEGASCOUT;

		public static bool firstPlayerIsGote = true;
		public static int depth = 3;

		#if DLE
		public static string logPath = @"C:\Cygwin\home\Dylan\Unity\Shogi\AISandbox\SandboxPlayer\PartiesDLE\";
		#elif BMA
...
//											{ Token.SPAWN  ,       0       ,  Token.SPAWN  , Token.JEWEL ,      0      ,      0      ,       0       ,        0      ,      0       } };
	...
	*/
		...
		public static void Main ()
		{
			...
			root.setState (ref Launcher.testState);
			...
			switch (goteAlgorithm)
			{
				...
				case Algorithm.NEGASCOUT:
					...
					break;
				case Algorithm.NEOALPHABETA:
					Console.Write ("********** Gote Algorithm: Neo AlphaBeta | ");
					gameWorkflow += "********** Gote Algorithm: Neo AlphaBeta | ";
					break;
			...
			switch (senteAlgorithm)
			{
				...
				case Algorithm.NEGASCOUT:
					...
					break;
				case Algorithm.NEOALPHABETA:
					Console.WriteLine ("Sente Algorithm: Neo AlphaBeta | Depth: {0} **********", depth);
					gameWorkflow += "Sente Algorithm: Neo AlphaBeta | Depth: " + depth.ToString () + " **********\n";
					break;
				case Algorithm.ALPHABETA:
				...
				if (isGote)
				{
					...
					switch (goteAlgorithm)
					{
						...
						case Algorithm.NEGASCOUT:
							...
							break;
						case Algorithm.NEOALPHABETA:
							move = NegaScoutClass.AlphaBeta (root, depth, isGote, movesPlayed, ref gameWorkflow);
							break;
						case Algorithm.ALPHABETA:
							move = AlphaBetaClass.AspirationSearch (root, depth, isGote, movesPlayed, index, ref gameWorkflow);
//							move = AlphaBetaClass.AlphaBeta (root, depth, isGote, movesPlayed, ref gameWorkflow);
							break;
						case Algorithm.MINMAX:
