...
namespace Tools
{
	public class Node
	{
		...
		public Node (bool isGote, Node parent, Token.TokenInfo tokenInfo, List<Token.TokenType> goteCapturedTokens, List<Token.TokenType> senteCapturedTokens, List<Node> children, ref int [,] initState)
		{
			...
			{
				Console.WriteLine ("Invalid Dim Node init [{0}, {1}]", initState.GetUpperBound (0) + 1, initState.GetUpperBound (1) + 1);
				return;
			}
		...
		public void getState (ref int [,] refState)
		{
			...
			{
				Console.WriteLine ("Invalid Dim getState [{0}, {1}]", refState.GetUpperBound (0) + 1, refState.GetUpperBound (1) + 1);
				return;
			}
		...
		public void setState (ref int [,] refState)
		{
			if (refState.GetUpperBound (0) + 1 != 9 || refState.GetUpperBound (1) + 1 != 9)
			{
				Console.WriteLine ("Invalid Dim setState [{0}, {1}]", refState.GetUpperBound (0) + 1, refState.GetUpperBound (1) + 1);
				return;
			}
